 ...
 * 
 * import com.alloy.model.Customer; import
 * com.alloy.repository.CustomerRepository;
 * 
 * @RunWith(SpringRunner.class)
 * 
 * @SpringBootTest public class CustomerRepositoryTests {
 * 
 ...
 * 
 * dave = repository.save(new Customer("Dave", "Matthews")); oliver =
 * repository.save(new Customer("Oliver August", "Matthews")); carter =
 * repository.save(new Customer("Carter", "Beauford")); }
 * 
 * @Test public void setsIdOnSave() { Customer dave = repository.save(new
 * Customer("Dave", "Matthews")); assertThat(dave.id).isNotNull(); }
 * 
 * @Test public void findsByLastName() {
 * 
